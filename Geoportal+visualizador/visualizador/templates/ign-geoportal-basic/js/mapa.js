...
//Change logotype
$('#top-left-logo-link').attr("href","../index.html");
$('#top-left-logo').attr("src","templates/ign-geoportal-basic/img/logomunicc.png");
$('#top-left-logo').attr("alt","Logo Municipalidad de Colonia Caroya");
$('#top-left-logo').attr("title","Municipalidad de Colonia Caroya");
$('#top-right-logo-link').attr("href","http://www.coloniacaroya.gov.ar/");
$('#top-right-logo').attr("src","templates/ign-geoportal-basic/img/municccompleto.png");

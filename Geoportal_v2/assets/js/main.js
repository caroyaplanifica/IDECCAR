...
!(function($) {
  ...
  document.getElementById('copyWMS').addEventListener('click', function() {
    copyToClipboard('Acá tenes tu link WMS');
  });
  document.getElementById('copyWFS').addEventListener('click', function() {
    copyToClipboard('Acá tenes tu link WFS');
  });
